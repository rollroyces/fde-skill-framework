# FDE Workflow (auto-loaded by Cline/Roo-Code)

This rule applies whenever the task is FDE-shaped: a named customer,
external delivery, or contracted SLA. Follow the four-phase loop
below before writing any code.

**Source of truth:** `.hermes/skills/fde-workflow.md` (kept in
sync by `scripts/build_adapters.py`).
