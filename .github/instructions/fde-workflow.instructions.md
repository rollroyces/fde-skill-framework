...
Apply this rule to every change in this repository. The FDE loop
is mandatory for any work tied to a customer outcome: refuse to
write code until Discovery is signed.
