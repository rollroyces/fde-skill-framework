...
Always apply this rule when the task touches a customer-facing
deliverable in this repository. The four-phase FDE loop below
must run end-to-end before any code is shipped.
