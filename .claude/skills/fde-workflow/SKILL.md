...
This skill applies to any task that is FDE-shaped: named customer,
external delivery, contracted SLA. It enforces a four-phase loop
(Discovery -> Architecture -> Build -> ROI Evaluation) and refuses
to write code until a named customer, metric M, baseline, target,
and SLA are on paper.
